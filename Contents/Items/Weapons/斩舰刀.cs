...
using AzurLane.Contents.Projectiles;
using Microsoft.Xna.Framework.Graphics;
using Terraria.GameContent;

namespace AzurLane.Contents.Items.Weapons
{
    public class 斩舰刀 : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("斩舰刀"); //为你的武器命名
            // Tooltip.SetDefault("绫波的斩舰刀");//这是武器的提示语，利用\n进行换行
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.width = 119;//物品以掉落物形式存在的碰撞箱宽度
            Item.height = 125;//物品以掉落物形式存在的碰撞箱高度
            Item.useTime = 20;//物品一次使用所经历的时间（以帧为单位）(正常情况1秒60帧)
            Item.shoot = ModContent.ProjectileType<斩舰刀刀光>();//物品发射的弹幕ID(泰拉剑气)
